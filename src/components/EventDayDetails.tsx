  ...
  return (
    <div className={`relative flex flex-col items-center h-min mb-28`}>
      <div className="font-pirata_one text-violet">
        <p className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-center mb-4 lg:mb-8">
          day 0{dayNumber}
        </p>
        <p className="text-lg md:text-xl lg:text-2xl xl:text-3xl text-center mb-2 lg:mb-4">
          Program Flow
        </p>
      </div>
      <SeeProgramButton
