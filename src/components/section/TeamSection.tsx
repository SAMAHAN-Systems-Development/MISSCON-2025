          ...
          <div
            className={`grid ${
              section.members.length % 3 === 0
                ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-2 md:gap-y-14 md:gap-x-24 lg:gap-y-24 justify-items-center'
                : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-2 justify-items-center gap-8'
            }`}
          >
